...
from ...model.plate import IMG_SIZE
...
def train_yolo(epochs=100, batch=16, device='cpu', lr0=0.01):
    print(f"Начинается обучением с параметрами epochs={epochs}, batch={batch}, device={device}, lr0={lr0}")
...
def main():
    ...
    parser.add_argument('--lr0', type=float, default=0.01, help="Шаг обучения")
